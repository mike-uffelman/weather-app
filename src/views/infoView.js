            ...
            <div class='info__content'>
                ...
                <ul class='info__list'>
                    <li class='info__item'>
                        ...
                        <p class='text__secondary'>If you've allowed your location in the browser your local weather will be automatically loaded. </p>
                        </li>
                    <li class='info__item'>
                        <div class='info__icon'>
                        ...
                        <p class='text__secondary'>If you've chosen to block your location you'll be directed to the search, where you can search by a location name or select a location on the map!</p>
                        </li>
                    <li class='info__item'>
                        <div class='info__info__icon'>
                        ...
                        <p class='text__secondary'>In the location weather view you can find the selected locations' weather, including current, hourly, daily forecasts, and the weather map!</p>
                    </li>
                    <li class='info__item'>
                        <div class='info__icon'>
                        ...
                        <p class='text__secondary'>If you'd like to save a location hit the save icon next to the location name!</p> 
                    <li class='info__item'>
                        <div class='info__icon'>
                        ...
                        <p class='text__secondary'>To view all your saved locations hit the all save icon!</p>
                    </li>
                </ul>
