            ...
            <div class='info__content'>
                ...
                <ul class='info__list'>
                    <li class='info__item'>
                        ...
                        </span>If you've allowed your location in the browser your local weather will be automatically loaded. 
                        </li>
                    <li class='info__item'>
                        <span class='info__icon'>
                    ...
                    If you've chosen to block your location you'll be directed to the search, where you can search by a location name or select a location on the map!</li>
                    <li class='info__item'>
                        <span class='info__info__icon'>
                        ...
                        In the location weather view you can find the selected locations' weather, including current, hourly, daily forecasts, and the weather map!
                    </li>
                    <li class='info__item'>
                        <span class='info__icon'>
                            <svg class='info__icon--bookmark' xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
                                <path d="M17 3H7c-1.1 0-2 .9-2 2v16l7-3 7 3V5c0-1.1-.9-2-2-2z"/>
                            </svg>
                        </span>
                        If you'd like to save a location hit the bookmark icon next to the location name! 
                    <li class='info__item'>
                        <span class='info__icon'>
                            <svg class='info__icon--bookmarks' xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"/>
                        ...
                        To view all your bookmarked locations hit the all bookmarks icon!
                    </li>
                </ul>
                <button class='info__btn'>Got it!</button>
            </div>
